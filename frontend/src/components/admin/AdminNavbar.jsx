...
import { LogOut, Menu, X, LayoutDashboard, MessageSquare, RefreshCw, Sprout, Package, ShoppingCart, FileText } from 'lucide-react';
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/admin" className="flex items-center space-x-3 group">
            <div className=" text-white p-3 rounded-lg group-hover:bg-forest-700 transition-colors">
              <img 
